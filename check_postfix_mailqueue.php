...
$def[1]  = "DEF:deferred=$rrdfile:$DS[1]:AVERAGE " ;
$def[1] .= "DEF:active=$rrdfile:$DS[2]:AVERAGE " ;
$def[1] .= "DEF:maildrop=$rrdfile:$DS[3]:AVERAGE " ;
$def[1] .= "DEF:incoming=$rrdfile:$DS[4]:AVERAGE " ;
$def[1] .= "DEF:corrupt=$rrdfile:$DS[5]:AVERAGE " ;
$def[1] .= "DEF:hold=$rrdfile:$DS[6]:AVERAGE " ;
